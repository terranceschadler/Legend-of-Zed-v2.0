...
{
    /// <summary>
    /// v3.9e safe zone-front-row building spawner.
    ///
    ...
    public sealed class ZedZoneBasedBuildingSpawner : MonoBehaviour
    {
        [Header("References")]
        ...
        public void BuildNow()
        {
            ...
            {
                Debug.Log(
                    "Zone-based building spawner complete. Zones=" + zonesFound +
                    ", ZonesUsed=" + zonesUsed +
